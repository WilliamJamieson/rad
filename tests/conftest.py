...
_OPTICAL_ELEMENTS = tuple(
    _CURRENT_RESOURCES[_get_latest_uri("asdf://stsci.edu/datamodels/roman/schemas/meta/helper/wfi_optical_element")]["enum"]
)
_EXPOSURE_TYPE_ELEMENTS = tuple(
    _CURRENT_RESOURCES[_get_latest_uri("asdf://stsci.edu/datamodels/roman/schemas/meta/helper/exposure_type")]["enum"]
)
